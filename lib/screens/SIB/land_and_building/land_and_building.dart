...
class ValuationFormPage extends StatefulWidget {
  const ValuationFormPage({super.key});
...
class _ValuationFormPageState extends State<ValuationFormPage> {
  ...
  List<pw.TableRow> _getPage2Table3Rows() {
    ...
    rows.add(pw.TableRow(children: [
      ...
      pw.Container(padding: cellPadding, child: pw.Text('Whether occupied by the Self /tenant? If occupied by tenant, since how long? Rent received per month.', style: contentTextStyle)),
      pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
      pw.Container(padding: cellPadding, child: pw.Text(
  ...
  List<pw.TableRow> _getPage2Table4Rows() {
    ...
    rows.add(
      pw.TableRow(
        children: [
          ...
          pw.Container(padding: cellPadding, child: pw.Text('Details /Floors', style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text('Occupancy\n(Self/Rented)', style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text('No. Of Room', style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text('No. Of Kitchen', style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text('No. of Bathroom', style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text('Usage Remarks\n(Resi/Comm)', style: contentTextStyle)),
        ],
      ),
    );
    ...
    rows.add(
      pw.TableRow(
        children: [
          pw.Container(padding: cellPadding, child: pw.Text('')), // Empty for S.No.
          pw.Container(padding: cellPadding, child: pw.Text('Ground', style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_groundFloorOccupancyController.text, style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_groundFloorNoOfRoomController.text, style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_groundFloorNoOfKitchenController.text, style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_groundFloorNoOfBathroomController.text, style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_groundFloorUsageRemarksController.text, style: contentTextStyle)),
        ],
      ),
    );
    ...
    rows.add(
      pw.TableRow(
        children: [
          pw.Container(padding: cellPadding, child: pw.Text('')), // Empty for S.No.
          pw.Container(padding: cellPadding, child: pw.Text('First', style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_firstFloorOccupancyController.text, style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_firstFloorNoOfRoomController.text, style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_firstFloorNoOfKitchenController.text, style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_firstFloorNoOfBathroomController.text, style: contentTextStyle)),
          pw.Container(padding: cellPadding, child: pw.Text(_firstFloorUsageRemarksController.text, style: contentTextStyle)),
        ],
      ),
    );
  ...
  List<pw.TableRow> _getPage3TableRows() {
    ...
    rows.add(pw.TableRow(children: [
      pw.Container(padding: cellPadding, child: pw.Text('21.', style: contentTextStyle)),
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(
          padding: cellPadding,
          alignment: pw.Alignment.centerLeft,
          child: pw.Text('Part - B (Valuation of Building)', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 12)),
        ),
      ],
    ));
  ...
  List<pw.TableRow> _getBuildingValuationTableRowsSubHeading() {
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('1.', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Technical details of the building', style: headerTextStyle)),
      ],
    ));
  ...
  List<pw.TableRow> _getBuildingValuationTableRows() {
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('')),
        pw.Container(padding: cellPadding, child: pw.Text('a', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Type of Building (Residential / Commercial / Industrial)', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_typeOfBuildingController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('')),
        pw.Container(padding: cellPadding, child: pw.Text('b', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Type of construction (Load bearing / RCC / Steel Framed)', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_typeOfConstructionController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('')),
        pw.Container(padding: cellPadding, child: pw.Text('c', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Age of the building', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_ageOfTheBuildingController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('')),
        pw.Container(padding: cellPadding, child: pw.Text('d', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Residual age of the building', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_residualAgeOfTheBuildingController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('')),
        pw.Container(padding: cellPadding, child: pw.Text('e', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Approved map / plan issuing authority', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_approvedMapAuthorityController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('')),
        pw.Container(padding: cellPadding, child: pw.Text('f', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Whether genuineness or authenticity of approved map / plan is verified', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_genuinenessVerifiedController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('')),
        pw.Container(padding: cellPadding, child: pw.Text('g', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Any other comments by our empanelled valuers on authentic of approved plan', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_otherCommentsController.text, style: contentTextStyle)),
      ],
    ));
  ...
  List<pw.TableRow> _getBuildUpAreaTableRows() {
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('S n', style: headerTextStyle)),
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('Particular of item', style: headerTextStyle)),
        // "Build up Area" header - placed in the first of the three columns it spans
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('Build up Area', style: headerTextStyle)),
        ...
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('Replacement\nCost in Rs.', style: headerTextStyle)),
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('Depreciation\nin Rs.', style: headerTextStyle)),
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('Net value\nafter\nDepreciations Rs.', style: headerTextStyle)),
      ],
    ));
    ...
    rows.add(pw.TableRow(
      children: [
        ...
        pw.Container(padding: cellPadding, child: pw.Text('')), // Empty for Particular of item
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('As per approved\nPlan/FSI', style: headerTextStyle)),
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('As per\nActual', style: headerTextStyle)),
        pw.Container(padding: cellPadding, alignment: pw.Alignment.center, child: pw.Text('Area\nConsidered\nfor the\nValuation', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('')), // Empty for Replacement Cost
        pw.Container(padding: cellPadding, child: pw.Text('')), // Empty for Depreciation
        pw.Container(padding: cellPadding, child: pw.Text('')), // Empty for Net value
      ],
    ));
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Ground\nfloor', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_groundFloorApprovedPlanController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_groundFloorActualController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_groundFloorConsideredValuationController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_groundFloorReplacementCostController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_groundFloorDepreciationController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_groundFloorNetValueController.text, style: contentTextStyle)),
      ],
    ));
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('First\nfloor', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_firstFloorApprovedPlanController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_firstFloorActualController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_firstFloorConsideredValuationController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_firstFloorReplacementCostController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_firstFloorDepreciationController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_firstFloorNetValueController.text, style: contentTextStyle)),
      ],
    ));
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Total', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_totalApprovedPlanController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_totalActualController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_totalConsideredValuationController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_totalReplacementCostController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_totalDepreciationController.text, style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_totalNetValueController.text, style: contentTextStyle)),
      ],
    ));
  ...
  List<pw.TableRow> _getAmenitiesTableRows() {
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('1.', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Wardrobes', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_wardrobesController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('2.', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Amenities', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_amenitiesController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('3.', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Any other Additional', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_anyOtherAdditionalController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('')),
        pw.Container(padding: cellPadding, child: pw.Text('Total', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_amenitiesTotalController.text, style: contentTextStyle)),
      ],
    ));
  ...
  List<pw.TableRow> _getTotalAbstractTableRows() {
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('Part- A', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Land', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('Part- B', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Building', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
    ...
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('Part- C', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Amenities', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
    ...
    rows.add(pw.TableRow(
      children: [
        ...
        pw.Container(padding: cellPadding, child: pw.Text('Total', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('₹ ${_totalAbstractTotalController.text}', style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('Say', style: headerTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(':', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text('₹ ${_totalAbstractSayController.text}', style: contentTextStyle)),
      ],
    ));
  ...
  List<pw.TableRow> _getFinalValuationTableRows() {
    ...
    rows.add(pw.TableRow(
      children: [
        ...
        pw.Container(padding: cellPadding, child: pw.Text(_presentMarketValueController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('Realizable Value of the Property', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_realizableValueController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('Distress Value of the Property', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_distressValueController.text, style: contentTextStyle)),
      ],
    ));
    rows.add(pw.TableRow(
      children: [
        pw.Container(padding: cellPadding, child: pw.Text('Insurable Value of the property', style: contentTextStyle)),
        pw.Container(padding: cellPadding, child: pw.Text(_insurableValueController.text, style: contentTextStyle)),
      ],
    ));
  ...
  Future<void> _generatePdf() async {
    ...
    final List<pw.TableRow> page2Table4Rows = _getPage2Table4Rows(); // Get rows for section 18
    final List<pw.TableRow> page2Table5Rows = _getPage2Table5Rows(); // Get rows for sections 19-20
    ...
    final List<pw.TableRow> landValuationRows = _getLandValuationTableRows(); // NEW: Get rows for land valuation
    final List<pw.TableRow> buildingValuationRowsHeading = _getBuildingValuationTableRowsHeading(); // NEW: Get rows for building valuation
    final List<pw.TableRow> buildingValuationTableRowsSubHeading = _getBuildingValuationTableRowsSubHeading(); // NEW: Get rows for building valuation
    final List<pw.TableRow> buildingValuationRows = _getBuildingValuationTableRows(); // NEW: Get rows for building valuation
    final List<pw.TableRow> buildUpAreaRows = _getBuildUpAreaTableRows(); // NEW: Get rows for build up area table
    final List<pw.TableRow> amenitiesTableRows = _getAmenitiesTableRows(); // NEW: Get rows for amenities table
    final List<pw.TableRow> totalAbstractTableRows = _getTotalAbstractTableRows(); // NEW: Get rows for total abstract table
    final List<pw.TableRow> finalValuationTableRows = _getFinalValuationTableRows(); // NEW: Get rows for final valuation table
        ...
        build: (pw.Context context) {
          return [
            ...
            pw.Table(
              ...
              columnWidths: {
                0: const pw.FlexColumnWidth(0.5), // S.No.
                1: const pw.FlexColumnWidth(1.5), // Details /Floors / Description
                2: const pw.FlexColumnWidth(1.5), // Occupancy (Self/Rented) / Colon
          ...
          return [
            ...
            pw.Table(
              ...
              columnWidths: {
                ...
                4: const pw.FlexColumnWidth(1.5), // Area Considered for the Valuation
                5: const pw.FlexColumnWidth(1.5), // Replacement Cost in Rs.
                6: const pw.FlexColumnWidth(1.5), // Depreciation in Rs.
                7: const pw.FlexColumnWidth(1.5), // Net value after Depreciations Rs.
              },
              children: [
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            ...
            pw.Center(
              child: pw.Text(
                'Part C- Amenities                                            (Amount in Rs.)', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 12),
                textAlign: pw.TextAlign.center,
              ),
            ),
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            const Expanded(flex: 2, child: Text('Details /Floors', style: TextStyle(fontWeight: FontWeight.bold))),
                            const Expanded(flex: 2, child: Text('Occupancy\n(Self/Rented)', style: TextStyle(fontWeight: FontWeight.bold))),
                            const Expanded(flex: 1, child: Text('No. Of Room', style: TextStyle(fontWeight: FontWeight.bold))),
                            const Expanded(flex: 1, child: Text('No. Of Kitchen', style: TextStyle(fontWeight: FontWeight.bold))),
                            const Expanded(flex: 1, child: Text('No. of Bathroom', style: TextStyle(fontWeight: FontWeight.bold))),
                            const Expanded(flex: 2, child: Text('Usage Remarks\n(Resi/Comm)', style: TextStyle(fontWeight: FontWeight.bold))),
                          ],
                        ),
                      ),
              ...
              ExpansionTile(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const Expanded(flex: 1, child: Text('S n', style: TextStyle(fontWeight: FontWeight.bold))),
                        const Expanded(flex: 2, child: Text('Particular of item', style: TextStyle(fontWeight: FontWeight.bold))),
                        const Expanded(flex: 2, child: Text('As per approved\nPlan/FSI', style: TextStyle(fontWeight: FontWeight.bold))),
                        const Expanded(flex: 2, child: Text('As per Actual', style: TextStyle(fontWeight: FontWeight.bold))),
                        const Expanded(flex: 2, child: Text('Area Considered\nfor the Valuation', style: TextStyle(fontWeight: FontWeight.bold))),
                        const Expanded(flex: 2, child: Text('Replacement Cost\nin Rs.', style: TextStyle(fontWeight: FontWeight.bold))),
                        const Expanded(flex: 2, child: Text('Depreciation\nin Rs.', style: TextStyle(fontWeight: FontWeight.bold))),
                        const Expanded(flex: 2, child: Text('Net value after\nDepreciations Rs.', style: TextStyle(fontWeight: FontWeight.bold))),
                      ],
                    ),
                  ),
